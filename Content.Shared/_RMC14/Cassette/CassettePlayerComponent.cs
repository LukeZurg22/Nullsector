...
public sealed partial class CassettePlayerComponent : Component
{
    ...
    [DataField, AutoNetworkedField]
    public SlotFlags[] Slots = [ SlotFlags.POCKET, SlotFlags.BELT ];
    ...
    [DataField, AutoNetworkedField]
    public SoundSpecifier PlayPauseSound = new SoundPathSpecifier("/Audio/Weapons/click.ogg");

    [DataField, AutoNetworkedField]
    public SoundSpecifier InsertEjectSound = new SoundPathSpecifier("/Audio/Weapons/Guns/Empty/lmg_empty.ogg");

    [DataField, AutoNetworkedField]
    public SpriteSpecifier.Rsi WornSprite = new(new ResPath("_RMC14/Objects/Devices/cassette_player.rsi"), "mob_overlay");

    [DataField, AutoNetworkedField]
    public SpriteSpecifier.Rsi MusicSprite = new(new ResPath("_Null/Clothing/Misc/headphones.rsi"), "music");
}
