nukeops-title = Armadan Operatives
nukeops-description = Armadan operatives have targeted the station. Try to keep them from arming and detonating the nuke by protecting the nuke disk!

nukeops-welcome =
    You are a armadan operative. Your goal is to blow up {$station}, and ensure that it is nothing but a pile of rubble. Your bosses, the Syndicate, have provided you with the tools you'll need for the task.
...
nukeops-cond-nukeactiveatcentcom = The nuclear bomb was delivered to Rogue Central Relay!
