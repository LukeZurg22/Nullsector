...
bounty-description-carp = Admiral Pavlov has gone on strike ever since Armadans confiscated her "pet." She is demanding a space carp as a replacement, dead or alive.
...
bounty-description-handcuffs = A large influx of escaped convicts have arrived at the Rogue Central Relay. Now is the perfect time to ship out spare handcuffs (or restraints).
...
bounty-description-monkey-cube = Due to a recent genetics accident, the Rogue Central Relay is in serious need of monkeys. Your mission is to ship monkey cubes.
...
bounty-description-toolbox = There's an absence of robustness at the Rogue Central Relay. Hurry up and ship some toolboxes as a solution.
