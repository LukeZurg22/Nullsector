...
station-event-bluespace-dungeon-end-announcement = Critical bluespace instability detected, the foreign object has exited the Null Sector.
...
station-event-bluespace-scrap-end-announcement = Critical bluespace instability detected, storm wreckage has exited the Null Sector.

station-event-bluespace-vault-start-announcement = A Congressional armored supply-vault is inbound to the Null Sector. The NCMC may declare the vault a restricted No Fly Zone. Station accounts will be rewarded for its safe return.
...
station-event-bluespace-cache-start-announcement = A Syndicate weapons cache is inbound to the Null Sector. The NCMC may declare the cache a No Fly Zone. Station accounts will be rewarded for guarding the cache.
...
station-event-bluespace-asteroid-start-announcement = Long range scans indicate an unusually large asteroid entering the Null Sector. Prospectors should divert operations for maximum profit potential.
...
station-event-bluespace-asteroid-end-announcement = Critical bluespace instability detected, the asteroid has exited the Null Sector.
...
station-event-bluespace-wizardfederation-scout-start-announcement = Attention all personnel! Rogue Central Relay detected a Bluespace Anomaly in your sector with the signature indicative of the imminent arrival of a small Wizard Federation vessel. Code: Intercept, Detain, Incarcerate. Arrest the intruders and prepare them for transportation to the Central Government for interrogation through the Congressional Contraband Exchange System (CCES).
...
station-event-bluespace-generic-ftl-start-announcement = Attention all personnel! An unidentified vessel is now entering the Null Sector. Investigate with caution.
