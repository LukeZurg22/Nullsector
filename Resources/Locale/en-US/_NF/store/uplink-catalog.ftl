...
uplink-security-swat-desc = A full-face covering version of the standard issue Gas Mask.
...
uplink-security-hoverbike-desc = Flatpack containing an old space-age turbine with bike handles. Keys already slotted in the ignition. Very safe.
