...
public sealed partial class RadarBlipSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<ActiveJetpackComponent, ComponentAdd>(OnJetpackActivated);
        SubscribeLocalEvent<ActiveJetpackComponent, ComponentRemove>(OnJetpackDeactivated);
    }
